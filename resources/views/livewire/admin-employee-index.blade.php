                            ...
                            <th class="px-4 py-3">
                                <div class="flex items-center">
                                    <button wire:click="sortBy('last_name')"
                                        class="text-xs font-bold uppercase tracking-wider">Name</button>
                            ...
                            <th class="px-4 py-3">
                                <div class="flex items-center">
                                    <button wire:click="sortBy('employee_id_number')"
                                        class="text-xs font-bold uppercase tracking-wider">Employee ID</button>
                            ...
                            <th class="px-4 py-3">
                                <div class="flex items-center">
                                    <button wire:click="sortBy('role')"
                                        class="text-xs font-bold uppercase tracking-wider">Role</button>
                                    @if ($sortColumn != 'role')
                                        <span></span>
                                    @elseif ($sortAscending)
                                        <span>
