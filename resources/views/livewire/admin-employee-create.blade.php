<div class="flex flex-col">
    ...
    <h2 class="font-bold text:lg lg:text-2xl text-center">Create Employee</h2>
    <h6 class="font-bold text-sm mt-4 mb-8 text-center">Please fill out the form below to create a 
        new employee account. All fields are required.
    </h6>
